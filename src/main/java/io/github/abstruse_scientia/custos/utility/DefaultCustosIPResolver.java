 ...
 * <p>Tries to extract the client IP address in this order:</p>
 * <p>1. X-Forwarded-For header (for reverse proxy/load balancer scenarios)</p>
 * <p>2. X-Real-IP header (for nginx scenarios)</p>
 * <p>3. request.getRemoteAddr() (direct connection)</p>
 * <p>This covers most common deployment scenarios without requiring custom implementation.</p>
 */
